...
import type { EEGPacket, DeviceSettings, ConnectionStats, ImpedancePoint, ProtocolValidationResult } from './types.js';
import { EEG_PARAMS, VOLTAGE_REF } from './protocol.js';
